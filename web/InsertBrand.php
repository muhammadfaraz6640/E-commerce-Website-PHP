...
<html>
    ...
    <section id = "nav-bar">                        
        ...
        <div class="container">
            <form id = "formlayoutinsert" action = "InsertBrand.php" method = "POST" enctype = "multipart/form-data" >                       
                <label class="ins_lab">Brand Name</label></br />
                <input type = "text" name = "brand_name"/></br />              
                <input type = "submit" name = "insert_Brand" value = "insert Now">
